...
export class InventoryPage {
  ...
  constructor(page: Page) {
    ...
    this.reservedQtyColumn = page.locator('td[data-testid="reserved-qty"], th:has-text("预占库存")');
    this.availableQtyColumn = page.locator('td[data-testid="available-qty"], th:has-text("可用库存")');
