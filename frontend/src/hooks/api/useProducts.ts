...
export const useProducts = ({
  ...
  return useQuery({
    queryKey: productKeys.productsPaginated(page, pageSize, filters),
...
export const useProductSearch = (
  ...
  return useQuery({
    queryKey: productKeys.searchProducts(query, filters),
    queryFn: async (): Promise<Product[]> => {
      const params = new URLSearchParams({
        q: query,
        ...Object.fromEntries(
...
export const useUpdateProduct = () => {
  ...
  return useMutation({
    mutationFn: async ({ id, ...updates }: UpdateProductParams): Promise<Product> => {
...
export const useBatchUpdateProducts = () => {
  ...
  return useMutation({
    mutationFn: async ({ ids, updates }: BatchOperationParams): Promise<Product[]> => {
...
export const useUpdateProductStock = () => {
  ...
  return useMutation({
    mutationFn: async ({ id, stock }: { id: string; stock: number }): Promise<Product> => {
