...
export function useSaveAttributeTemplateMutation() {
  ...
  return useMutation({
    mutationFn: async ({ categoryId, attributes }: { categoryId: string; attributes: CategoryAttribute[] }) => {
...
export function useAddAttributeMutation() {
  ...
  return useMutation({
    mutationFn: async ({ categoryId, attribute }: { categoryId: string; attribute: Omit<CategoryAttribute, 'id' | 'createdAt' | 'updatedAt'> }) => {
      const response = await attributeService.addAttribute(categoryId, attribute as CategoryAttribute)
      if (response.success) {
        return response.data
      }
...
export function useUpdateAttributeMutation() {
  ...
  return useMutation({
    mutationFn: async ({ categoryId, attributeId, attribute }: { categoryId: string; attributeId: string; attribute: Partial<CategoryAttribute> }) => {
