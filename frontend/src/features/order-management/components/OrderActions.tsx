 ...
 * ```
 */
export const OrderActions: React.FC<OrderActionsProps> = React.memo(({ order, onSuccess }) => {
      ...
      <Space className="order-actions">
        ...
        {canShip && (
          <Popconfirm
            ...
            cancelText="取消"
          >
            <Button type="primary" icon={<SendOutlined />} loading={updateStatus.isPending}>
              标记发货
            </Button>
          </Popconfirm>
        )}
        ...
        {canComplete && (
          <Popconfirm
            ...
            cancelText="取消"
          >
            <Button type="primary" icon={<CheckOutlined />} loading={updateStatus.isPending}>
              标记完成
            </Button>
          </Popconfirm>
        )}
