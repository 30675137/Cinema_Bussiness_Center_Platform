        ...
        <>
          ...
          <Descriptions title="调整信息" column={1} bordered size="small">
            <Descriptions.Item label="调整类型">
              <Tag color={
                adjustment.adjustmentType === 'surplus' ? 'green' :
                adjustment.adjustmentType === 'shortage' ? 'orange' : 'red'
              }>
                {adjustment.adjustmentType === 'surplus' ? '盘盈' :
                 adjustment.adjustmentType === 'shortage' ? '盘亏' : '报损'}
              </Tag>
            </Descriptions.Item>
