...
ALTER TABLE "beverage_order_items" ADD CONSTRAINT "check_quantity" CHECK ((quantity > (0)::numeric));
...
ALTER TABLE "beverage_orders" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'INACTIVE'::character varying, 'OUT_OF_STOCK'::character varying])::text[])));

ALTER TABLE "beverage_orders" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'CALLED'::character varying, 'COMPLETED'::character varying])::text[])));

ALTER TABLE "beverage_orders" ADD CONSTRAINT "check_total_price" CHECK ((total_price >= (0)::numeric));

CREATE UNIQUE INDEX beverage_orders_order_number_key ON public.beverage_orders USING btree (order_number);
...
CREATE UNIQUE INDEX unique_beverage_spec ON public.beverage_specs USING btree (beverage_id, spec_type, spec_name);
...
ALTER TABLE "beverages" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'INACTIVE'::character varying, 'OUT_OF_STOCK'::character varying])::text[])));

ALTER TABLE "beverages" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'CALLED'::character varying, 'COMPLETED'::character varying])::text[])));
...
CREATE UNIQUE INDEX uk_bom_component ON public.bom_components USING btree (finished_product_id, component_id);
...
CREATE UNIQUE INDEX brands_brand_code_key ON public.brands USING btree (brand_code);
...
CREATE UNIQUE INDEX uk_combo_sub_item ON public.combo_items USING btree (combo_id, sub_item_id);
...
CREATE UNIQUE INDEX halls_store_id_code_key ON public.halls USING btree (store_id, code);
...
CREATE UNIQUE INDEX inventory_adjustments_adjustment_number_key ON public.inventory_adjustments USING btree (adjustment_number);
...
CREATE UNIQUE INDEX package_addons_package_id_addon_item_id_key ON public.package_addons USING btree (package_id, addon_item_id);
...
CREATE UNIQUE INDEX package_hall_associations_package_id_hall_type_id_key ON public.package_hall_associations USING btree (package_id, hall_type_id);
...
CREATE UNIQUE INDEX package_rules_package_id_key ON public.package_rules USING btree (package_id);
...
CREATE UNIQUE INDEX product_orders_order_number_key ON public.product_orders USING btree (order_number);
...
ALTER TABLE "queue_numbers" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'INACTIVE'::character varying, 'OUT_OF_STOCK'::character varying])::text[])));

ALTER TABLE "queue_numbers" ADD CONSTRAINT "check_status" CHECK (((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'CALLED'::character varying, 'COMPLETED'::character varying])::text[])));

CREATE UNIQUE INDEX unique_store_date_sequence ON public.queue_numbers USING btree (store_id, date, sequence);

CREATE UNIQUE INDEX unique_order ON public.queue_numbers USING btree (order_id);
...
ALTER TABLE "recipe_ingredients" ADD CONSTRAINT "check_quantity" CHECK ((quantity > (0)::numeric));

CREATE INDEX idx_recipe_ingredient ON public.recipe_ingredients USING btree (recipe_id);

CREATE UNIQUE INDEX unique_recipe_sku ON public.recipe_ingredients USING btree (recipe_id, sku_id);
...
CREATE UNIQUE INDEX unique_package_store ON public.scenario_package_store_associations USING btree (package_id, store_id);
...
CREATE UNIQUE INDEX skus_code_key ON public.skus USING btree (code);
...
CREATE UNIQUE INDEX spus_code_key ON public.spus USING btree (code);
...
CREATE UNIQUE INDEX store_inventory_store_id_sku_id_key ON public.store_inventory USING btree (store_id, sku_id);
...
CREATE UNIQUE INDEX store_reservation_settings_store_id_key ON public.store_reservation_settings USING btree (store_id);
...
CREATE UNIQUE INDEX uk_conversion_from_to ON public.unit_conversions USING btree (from_unit, to_unit);
