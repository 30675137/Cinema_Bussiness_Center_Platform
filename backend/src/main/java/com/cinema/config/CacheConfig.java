 ...
 *
 * Purpose: Configure caching for BOM formulas and menu categories
 * Author: Generated by P005 spec, extended by O002 spec
 * Date: 2025-12-29
 */
...
public class CacheConfig {
     ...
     * 客户端菜单分类缓存
     */
    public static final String CLIENT_MENU_CATEGORIES_CACHE = "clientMenuCategories";
