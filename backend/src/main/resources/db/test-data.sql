...
INSERT INTO unit_conversions (id, from_unit, to_unit, conversion_rate, category) VALUES
                                                                                     ('1b798092-d604-412e-8bbb-91ad2f487f91', 'kg', 'g', 1000.000000, 'weight'),  -- 重量换算开始
                                                                                     ...
                                                                                     ('66761653-122b-44bc-9db2-009caab7d8a4', 'l', 'ml', 1000.000000, 'volume'),  -- 体积换算开始
                                                                                     ...
                                                                                     ('17b91919-ecef-4a29-849e-34bce6b936ac', '箱', '瓶', 12.000000, 'quantity'),  -- 数量换算开始
...
INSERT INTO categories (id, code, name, parent_id, level, sort_order, status, created_at, updated_at) VALUES
                                                                                                          ('11111111-1111-1111-1111-111111111111', 'CAT001', '酒水饮料', NULL, 1, 1, 'ACTIVE', NOW(), NOW()),  -- 一级分类开始
                                                                                                          ...
                                                                                                          ('11111111-1111-1111-1111-111111111112', 'CAT001-01', '威士忌', '11111111-1111-1111-1111-111111111111', 2, 1, 'ACTIVE', NOW(), NOW()),  -- 二级分类开始
                                                                                                          ...
                                                                                                          ('4c2070e2-c7b8-4038-a0f3-3ab4a1a09449', 'STEMWARE', '高脚杯', 'fa956d8d-2abb-464a-ab18-ea3f279a26f2', 3, 1, 'ACTIVE', NOW(), NOW())  -- 三级分类
ON CONFLICT (id) DO NOTHING;
