---
name: ops-expert
description: 影院商品管理中台运营专家。当用户需要以下操作时使用此skill：(1) 查询场景包、门店、影厅、预约等数据；(2) 执行场景包发布/下架、门店设置修改等操作；(3) 获取系统操作指导和业务规则说明。触发词：查询、查看、显示、统计、发布、下架、修改、设置、如何、怎么、运营、场景包、门店、影厅、预约。
version: 0.1.0
---
