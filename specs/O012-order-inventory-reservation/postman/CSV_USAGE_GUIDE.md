# O012 Postman CSV 测试数据使用指南

## 📋 文件说明

本目录包含以下Postman测试文件：

1. **O012-order-reservation.postman_collection.json** - API测试集合
2. **O012-local.postman_environment.json** - 本地环境配置
3. **O012-test-data.csv** - CSV批量测试数据（数据驱动测试）
